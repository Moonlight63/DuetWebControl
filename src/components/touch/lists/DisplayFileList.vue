<template>
	<div class="component">
		...
		<touch-base-file-list ref="filelist" v-model="selection" :directory.sync="directory" :loading.sync="loading" sort-table="menu" @fileClicked="fileClicked" no-files-text="list.menu.noFiles">
			<!-- Files go here -->
