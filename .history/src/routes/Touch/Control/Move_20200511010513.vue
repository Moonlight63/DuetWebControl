			...
			<div class="component d-flex flex-column flex-grow-1" style="min-height: 0">
				<v-container style="overflow: auto">
					<v-row justify="center">
                        ...
                        to="/touch/control" 
                        label="Home X" 
                        :icon="getAxisByLetter('X').homed ? 'mdi-home-circle-outline' : 'home-alert'" 
                    ...
                    <v-row justify="center">
                        ...
                        to="/touch/control" 
                        label="Home Y" 
                        :icon="getAxisByLetter('Y').homed ? 'mdi-home-circle-outline' : 'home-alert'" 
                    ...
                    <v-row justify="center">
                        ...
                        to="/touch/control" 
                        label="Home Z" 
                        :icon="getAxisByLetter('Z').homed ? 'mdi-home-circle-outline' : 'home-alert'" 
