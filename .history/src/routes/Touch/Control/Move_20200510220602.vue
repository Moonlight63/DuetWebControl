			...
			<div class="component d-flex flex-column flex-grow-1" style="min-height: 0">
				<v-container style="overflow: auto">
					<v-row justify="center">
                        ...
                        <touch-nav-btn @click="setDistanceIndex('X')" :label="distanceLabel('X')" icon="mdi-map-marker-distance"></touch-nav-btn>
					</v-row>
                    <v-row justify="center">
                        ...
                        <touch-nav-btn @click="setDistanceIndex('Y')" :label="distanceLabel('Y')" icon="mdi-map-marker-distance"></touch-nav-btn>
					</v-row>
                    <v-row justify="center">
                        ...
                        <touch-nav-btn @click="setDistanceIndex('Z')" :label="axisStepIndex['Z']" icon="mdi-map-marker-distance"></touch-nav-btn>
					</v-row>
				</v-container>
			</div>
		</v-col>
...
export default {
	...
	methods: {
        ...
        distanceLabel(axisLetter) {
            return this.moveSteps(axisLetter)[this.axisStepIndex[axisLetter]]+'mm'
        }
	},
	watch: {
		isConnected() {
