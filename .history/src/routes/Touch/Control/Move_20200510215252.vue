			...
			<div class="component d-flex flex-column flex-grow-1" style="min-height: 0">
				<v-container style="overflow: auto">
					<v-row justify="center">
                        ...
                        <touch-nav-btn @click="setDistanceIndex('X')" :label="moveSteps('X')[axisStepIndex['X']]+'mm'" icon="mdi-map-marker-distance"></touch-nav-btn>
					</v-row>
                    <v-row justify="center">
                        ...
                        <touch-nav-btn @click="setDistanceIndex('Y')" :label="moveSteps('Y')[axisStepIndex['Y']]+'mm'" icon="mdi-map-marker-distance"></touch-nav-btn>
					</v-row>
                    <v-row justify="center">
                        ...
                        <touch-nav-btn @click="setDistanceIndex('Z')" :label="moveSteps('Z')[axisStepIndex['Z']]+'mm'" icon="mdi-map-marker-distance"></touch-nav-btn>
					</v-row>
				</v-container>
			</div>
		</v-col>
