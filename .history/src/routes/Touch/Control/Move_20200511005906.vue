			...
			<div class="component d-flex flex-column flex-grow-1" style="min-height: 0">
				<v-container style="overflow: auto">
					<v-row justify="center">
                        ...
                        <touch-nav-btn to="/touch/control" label="Home X" icon="mdi-home-circle-outline" :color="displayedAxes.filter(axis => axis.letter == 'X')[0].homed ? 'primary' : 'warning'"></touch-nav-btn>
