			...
			<div class="component d-flex flex-column flex-grow-1" style="min-height: 0">
				<v-container style="overflow: auto">
                    ...
                    <v-row justify="center">
                        ...
                        <touch-nav-btn @click="setDistanceIndex(y)" :label="showSign(moveSteps(Y)[axisStepIndex[Y]])" icon="mdi-map-marker-distance"></touch-nav-btn>
					</v-row>
                    <v-row justify="center">
...
export default {
    ...
    mounted() {
        this.displayedAxes.forEach(axis => {
            this.axisStepIndex[axis.letter] = 0;
        });
