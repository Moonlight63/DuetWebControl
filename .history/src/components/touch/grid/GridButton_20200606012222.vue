    ...
    <grid-panel ref="elm" :columns='columns || 2' :rows='rows || 2' elevation="0">
        ...
        >
            ...
            <div v-else class="d-flex flex-column text-center justify-center fill-height" style="width: 100%;">
                <div ref="iconTest" class="mx-6">
                    <!-- <v-icon ref="icon" class="mb-0 flex-shrink-1 notransition py-0 pr-2" :color="iconColor" style="width:auto; height:auto">{{ icon }}</v-icon> -->
                    <!-- <v-icon size="1" ref="icon" class="mb-0 notransition" :color="iconColor">{{ icon }}</v-icon> -->
                    <span ref="icon" class="textFitted text-center d-inline-block">
                        H
                    </span>
                </div>
    ...
    methods: {
        ...
        updateIconSize() {
            ...
            while (low <= high) {
                ...
                console.log('width ' + innerSpan.clientWidth);
                console.log('mid ' + mid);
