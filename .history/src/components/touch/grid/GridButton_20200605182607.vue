            ...
            <div v-if="rows == 1" class="d-flex fill-height" style="width:100%;">
                <div ref="iconTest" class="fill-height">
                    <!-- <span ref="innerSpanIcon" class="iconFitted text-center d-inline-block"> -->
                        <v-icon ref="icon" class="mb-0 flex-shrink-1 notransition pa-2" :color="iconColor" style="width:auto; height:auto">{{ icon }}</v-icon>
                    <!-- </span> -->
                </div>
    ...
    methods: {
        ...
        updateIconSize() {
            ...
            while (low <= high && count < 21) {
                ...
                console.log('Span Scroll Height: ' + this.innerHeight(innerSpan));
