<template>
    <grid-panel ref="elm" :columns='columns || 2' :rows='rows || 2' elevation="0">
        <v-btn 
        class="ma-0" :class="rows == 1 ? '' : ' py-4 align-stretch flex-column'" 
...
export default {
    ...
    methods: {
        ...
        updateFontSize() {
            ...
            while (low <= high) {
                console.log(el);
                console.log('low before ' + low);
                console.log('high before ' + high);
                mid = (high + low) >> 1;
                ...
                if(low > high && (innerSpan.scrollWidth > originalWidth || innerSpan.scrollHeight > originalHeight)) {
                    console.log('triggered');
                    low = 6;
                }
                console.log('low after ' + low);
                console.log('high after ' + high);
                console.log(originalHeight);
                console.log(innerSpan.scrollHeight);
