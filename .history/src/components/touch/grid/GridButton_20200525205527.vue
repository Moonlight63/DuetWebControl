<template>
    <grid-panel :columns='columns || 2' :rows='rows || 2' elevation="0">
        ...
        >
            ...
            <div v-if="rows == 1" class="d-flex flex-row text-center justify-center fill-height">
                <v-icon :size="iconSize" class="mb-0" :color="iconColor" left>{{ icon }}</v-icon>
                <!-- <div ref="text" :style="fontStyle"> -->
                    {{ label }}
                <!-- </div> -->
            </div>
