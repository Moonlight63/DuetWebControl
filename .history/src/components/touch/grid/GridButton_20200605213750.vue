            ...
            <div v-if="rows == 1" class="d-flex fill-height py-2" style="width:100%;">
                <div ref="iconTest" class="fill-height">
                    <!-- <span ref="innerSpanIcon" class="iconFitted text-center d-inline-block"> -->
                        <v-icon ref="icon" :size="iconSize" class="mb-0 flex-shrink-1 notransition py-0 pr-2" :color="iconColor" style="width:auto; height:auto">{{ icon }}</v-icon>
                    <!-- </span> -->
                </div>
...
export default {
    ...
    updated() {
        ...
        console.log("Update:");
        console.log(this.innerWidth(this.$refs.text));
    ...
    methods: {
        ...
        iconSizeTest(low, high, originalW, originalH) {
            ...
            if (low <= high) {
                ...
                let originalWidth = originalW || this.innerWidth(el);
                let originalHeight = originalH || this.innerHeight(el);

                console.log('innerHeight: ' + originalHeight);
                console.log('ClientHeight: ' + innerSpan.scrollHeight);
                ...
                this.$nextTick(this.iconSizeTest(low, high, originalWidth, originalHeight));
            } else {
                console.log('found!');
                console.log(this.innerWidth(this.$refs.text));
                console.log(this.$refs.text);
        ...
        updateIconSize() {
            ...
            // let firstWidth = this.innerWidth(this.$refs.text);
            // let count = 0;
            // while(this.innerWidth(this.$refs.text) == firstWidth && count < 2000000) {
            //     // do nothing
            //     count++;
            // }
            ...
            // let lastWidthRecord = this.innerWidth(el2);
            // let count = 0;
            // while(this.innerWidth(el2) == lastWidthRecord && count < 20000) {
            //     count ++;
            //     console.log(count);                
            // }

            //setTimeout(this.updateFontSize, 2000);
            //this.updateFontSize();
        ...
        updateSizes() {
            //this.$nextTick(this.iconSizeTest(4, 80));
            this.updateIconSize();
            //this.updateFontSize()
