<template>
  <grid-panel v-bind="$attrs" class="d-flex flex-column pa-2">
      ...
      <div class="flex-grow-1" style="margin-top: 1rem; margin-bottom: 1rem; display: grid; grid-template-columns: minmax(0, 1fr); grid-template-rows: repeat(3, minmax(1fr, 1fr)); grid-gap: 1rem; grid-auto-rows: 0.5fr;">
