<template>
    <grid-panel ref="elm" :columns='columns || 2' :rows='rows || 2' elevation="0">
        <v-btn 
        class="ma-0 align-stretch flex-direction-column" width="100%" max-width="100%" height="100%" 
        ...
        >
            ...
            <div v-else class="d-flex flex-column text-center justify-center fill-height">
                ...
                <div ref="text" class="flex-grow-1 d-flex align-center text-center fill-height">
                    <span ref="innerSpan" class="textFitted text-center d-inline-block">
                        {{ label }}
                    </span>
                </div>
