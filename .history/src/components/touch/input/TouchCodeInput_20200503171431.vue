...
<template>
	...
	<v-dialog v-model="shown" fullscreen persistent transition="dialog-bottom-transition">
		<v-card class="d-flex flex-column">
			...
			<v-card class="mx-auto mt-10 flex-gow-1" style="width: 50%">
				<v-card-text>
					{{ $t('input.code.placeholder') }}
			...
			<v-container class="d-flex py-0 justify-center">
				<touch-keyboard @onChange="onKeyboardChange" @onKeyPress="onKeyPress" :input="code" :theme="keyboardTheme" :numericOnly="isNumericValue" />			
			</v-container>
		</v-card>
	</v-dialog>
