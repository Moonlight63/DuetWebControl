<template>
	<div class="component d-flex flex-column flex-grow-1" style="min-height: 0">
		<v-toolbar class="flex-grow-0">
			<v-btn class="hidden-sm-and-down mr-3" :disabled="uiFrozen" color="primary">
				<v-icon class="mr-1">mdi-arrow-left</v-icon> Go Back
			</v-btn>

			<v-btn v-if="directory !== initialDirectory" class="hidden-sm-and-down mr-3" :disabled="uiFrozen" color="primary">
