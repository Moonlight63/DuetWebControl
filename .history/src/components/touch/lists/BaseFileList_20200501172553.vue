...
<template>
	<div style="height: 100%">
		...
		<touch-input-dialog is-numeric-value :shown.sync="renameDialog.shown" :title="$t('dialog.renameFile.title')" :prompt="$t('dialog.renameFile.prompt')" :preset="renameDialog.item && renameDialog.item.name" @confirmed="renameCallback"></touch-input-dialog>
	</div>
</template>
